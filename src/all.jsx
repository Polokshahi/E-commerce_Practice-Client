...
// TotalProductCard.jsx
import { FaShoppingCart } from "react-icons/fa";
import { Link } from "react-router";
import AllProductLenght from "../../../Hook/ProductLength/AllProductLenght";

const TotalProductCard = () => {
  const { length } = AllProductLenght(); // hook থেকে length নিলাম

  return (
    <Link
      to="/productDetails"
      className="bg-white shadow rounded-xl p-6 border-l-4 border-teal-500 flex items-center justify-between transition-transform duration-200 hover:scale-105 hover:shadow-lg"
    >
      <div>
        <p className="text-3xl font-bold text-gray-800">{length}</p>
